...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  /*
	  //HAL_GPIO_Write_Pin 함수 사용시
	  HAL_GPIO_WritePin(GPIOC, LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin|LED5_Pin|LED6_Pin|LED7_Pin|LED8_Pin, GPIO_PIN_SET);
	  HAL_Delay(1000);
	  HAL_GPIO_WritePin(GPIOC, LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin|LED5_Pin|LED6_Pin|LED7_Pin|LED8_Pin, GPIO_PIN_RESET);
	  HAL_Delay(1000);
	  */
    /* USER CODE BEGIN 3 */

	  //HAL_GPIO_TogglePin 함수 사용 시
